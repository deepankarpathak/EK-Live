...
<?php do_action('woocommerce_before_shop_loop_item'); ?>
    ...
    <?php if ($flatsome_opt['product_hover'] == "fade_in_back" || !isset($flatsome_opt['product_hover'])) { ?>
                ...
                if ($flatsome_opt['add_to_cart_icon'] == "show") :
                    ...
                    echo apply_filters('woocommerce_loop_add_to_cart_link', sprintf('<div href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="%s product_type_%s tip-top add-to-cart-grid" title="%s"><div class="cart-image">
...
if (!isset($flatsome_opt['grid_style']) || $flatsome_opt['grid_style'] == "grid1") {
    ...
    ?>
                    ...
                    echo $prod_name . ' - ' . $univ_shrt_name;
                } ?> </p>
                   <div class="duration_below_title-list"><span class="short-description_sapn"> <p class="edu-duration-list"><?php echo $duration; ?></p></span> <span class="edu-ins-name"><?php echo "University : " . $university_name->name; ?></span>

                    <p><?php if ($provider_object->name != '') {
                    echo "Provider : " . $provider_object->name;
                    } ?></p></div>
