...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly ?>
 ...
 <div style="" class="">
  ...
  <table style="" class="">
    <tbody style="" class="">
      <tr valign="top" style="" class="">
        <td width="53%" align="left" style="" class=""><div style="" class="">Please feel free to contact us for your queries related to the course by calling us on +91-11-49323333 or email us at <a href="mailto:support@EduKart.com" style="color:#000; font-weight: bold;" class="">support@EduKart.com</a> . We look forward to being with you as you go through the course on <a href="http://EduKart.com" target="_blank" style="color:#000; font-weight: bold;" class="">EduKart.com</a> .</div>
          <br style="" class="">
          Enjoy your learning! <br style="" class="">
          <br style="" class="">
          Thank you,<br style="" class="">
          Customer Relations<br style="" class="">
          <a href="http://EduKart.com" target="_blank" style="" class="">EduKart.com</a><br style="" class="">
          Telephonic Support: +91-11-49323333<br style="" class="">
          Email Support: <a href="mailto:support@EduKart.com" style="" class="">support@EduKart.com</a><br style="" class=""></td>
      </tr>
      <tr style="" class="">
        <td style="" class=""><hr style="" class="">
          <div style="font-size: 9px;" class=""> Declaration:<br style="" class="">
            <a href="http://EduKart.com" target="_blank" style="color:#000; font-weight: bold;" class="">EduKart.com</a> is a trademark of Earth Education Valley Pvt. Ltd. This invoice shows the final selling price of the course and is inclusive of all taxes, shipping and handling charges. <br style="" class="">
          ...
          <div style="font-size: 9px;" class=""> Terms and Conditions:<br style="" class="">
            1)The sale is governed by the Cancellation and Refund Policy as mentioned on <a target="_blank" href="http://www.edukart.com" style="" class="">www.edukart.com</a>.<br style="" class="">
            2)Interest @ 24% per annum will be charged on overdue accounts.<br style="" class="">
            3)Subject to Delhi jurisdiction only.<br style="" class="">
          </div>
          <hr style="" class=""></td>
      </tr>
    </tbody>
