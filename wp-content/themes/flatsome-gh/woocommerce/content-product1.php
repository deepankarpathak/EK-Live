...
if($_REQUEST['view'] == 'list'){
	$cls = 'edu-list-product';
	}
?>

<li class="product-small <?php if($stock_status == "1") { ?>out-of-stock<?php }?> <?php echo $flatsome_opt['grid_style']; ?> <?php echo $cls; ?>">
<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
<div class="inner-wrap  akhand">
