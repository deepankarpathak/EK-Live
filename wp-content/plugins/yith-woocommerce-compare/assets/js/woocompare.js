jQuery(document).ready(function($) {
    ...
    // add into table
    $(document).on( 'click', '.compare_link:not(.added), .product a.compare:not(.added)', function(e){
        e.preventDefault();
        var button = $(this),
            data = {
                _yitnonce_ajax: yith_woocompare.nonceadd,
                action: yith_woocompare.actionadd,
                id: button.attr("data-prod_id"),
                context: 'frontend'
            },
    ...
    $(document).on('click', '.compare_link.added, .product a.compare.added', function (ev) {
        ev.preventDefault();

        var table_url = $(this).attr("href");
    ...
    $(document).on( 'click', '.remove a', function(e){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('.dataTables_scrollBody > table.compare-list').replaceWith( table );
