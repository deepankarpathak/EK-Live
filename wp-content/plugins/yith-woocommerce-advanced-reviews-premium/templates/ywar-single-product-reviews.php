    ...
    <div class="reviews_bar">
        ...
        <?php for ($i = 5; $i >= 1; $i--) :
            ...
            <div class="ywar_review_row">
                ...
                <span class="ywar_stars_value"><?php printf(_n('%s star', '%s stars', $i, 'ywar'), $i); ?></span>
                <span class="ywar_num_reviews"><?php echo $review_stats[$i]; ?></span>
				<span class="ywar_rating_bar"><span style="background-color:<?php echo get_option('ywar_summary_bar_color'); ?>" class="ywar_scala_rating">
