		...
		if (! is_admin()) {
			if (self::is_on()) {
                ...
                if ( version_compare( $wp_version, '2.8.0', '>' ) ) {          
                	...
                	add_action( 'wp_print_scripts', array( WC_Frontend_Scripts, 'localize_printed_scripts' ), 0);
                	add_action( 'wp_print_footer_scripts', array( WC_Frontend_Scripts, 'localize_printed_scripts' ), 0 );
