...
#mega_main_menu' . $location_class . ' > .menu_holder > .menu_inner
{
...
*/
#mega_main_menu' . $location_class . '.first-lvl-align-right.no-logo.no-search > .menu_holder > .menu_inner > ul > li:last-child > .item_link
{
