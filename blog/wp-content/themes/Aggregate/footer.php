	...
	<!-- COmmenting Copyright						<p id="copyright"><?php esc_html_e('Designed by ','Aggregate'); ?> <a href="http://www.elegantthemes.com" title="Premium WordPress Themes">Elegant WordPress Themes</a> | <?php esc_html_e('Powered by ','Aggregate'); ?> <a href="http://www.wordpress.org">WordPress</a></p>  -->
			</div> <!-- end .container -->
...
<div class="fb-recommendations-bar" data-href="https://www.edukart.com" data-trigger="X%" data-side="left" data-site="http://www.edukart.com"></div>
</body>
</html>