...
<div id="theme-doc" class="about-wrap">
	...
	<p> BresponZive Pro is a Premium WordPress theme that has come with Magazine/blog style layout. It is an easy-to-customize and fully featured WordPress Theme. It has 2 columns, unlimited homepage Widgetized sections. Theme has come with WP Nav menus, Widgetized sidebars and Popular Widgets. Theme is built on advanced solid framework which includes lots of advanced features and functions. </p>
	
 <h3> Theme Documentaion</h3>
 <p>	The PHP code of the theme is licensed under the GPL license as is WordPress itself. You can read it here:  <a href="http://demo.themepacific.com/docs/bresponZive/" target="_blank">Documentation</a> </p>
